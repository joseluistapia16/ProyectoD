...
class Registro:
    ...
    def __getLabels(self):
        posX =120
        lb1 = Label(self.marco,fg="black", text="Registro de usuarios",
                    bg=self.fondo,font=("Arial",18)).place(x=220,
                                                          y=30)
        lb2 = Label(self.marco,fg="black", text="Usuario",
                    bg=self.fondo,font=("Arial",18)).place(x=posX,
                                                          y=100)
        lb3 = Label(self.marco,fg="black", text="Password",
                    bg=self.fondo,font=("Arial",18)).place(x=posX,
                                                          y=150)
        lb4 = Label(self.marco,fg="black", text="Nombres",
                    bg=self.fondo,font=("Arial",18)).place(x=posX,
                                                          y=200)
        lb5 = Label(self.marco,fg="black", text="Apellidos",
                    bg=self.fondo,font=("Arial",18)).place(x=posX,
                                                          y=250)
        lb6 = Label(self.marco,fg="black", text="Correo",
                    bg=self.fondo,font=("Arial",18)).place(x=posX,
                                                          y=300)
        lb7 = Label(self.marco,fg="black", text="Profesion",
                    bg=self.fondo,font=("Arial",18)).place(x=posX,
                                                          y=350)
    ...
    def __getInputs(self):
        posX=350
        self.usuario = Entry(self.marco,font=("Tahoma",16))
        self.usuario.place(x=posX,y=100,width=180,height=25)
        self.password = Entry(self.marco,font=("Tahoma",16))
        self.password.config(show="*")
        self.password.place(x=posX,y=150,width=180,height=25)
        self.nombres= Entry(self.marco,font=("Tahoma",16))
        self.nombres.place(x=posX,y=200,width=180,height=25)
        self.apellidos= Entry(self.marco,font=("Tahoma",16))
        self.apellidos.place(x=posX,y=250,width=180,height=25)
        self.correo= Entry(self.marco,font=("Tahoma",16))
        self.correo.place(x=posX,y=300,width=180,height=25)
    ...
    def getData(self):
        ...
        obj = Usuario(self.usuario.get(),
                      self.password.get(),
                      self.nombres.get(),
                      self.apellidos.get(),
                      self.correo.get(),
                      self.lista[pos])
        reg = obj.usuario+","+obj.password+","+obj.nombres+","+obj.apellidos\
              +","+obj.correo+","+obj.profesion+",\n"
    ...
    def accion1(self):
        ...
        if obj!=None:
           messagebox.showinfo("Mensaje!", "Usuario ya existe!.", parent=self.ven)